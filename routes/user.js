...
router.get(
  "/login-otp",
  middleware.sessionHandle,
  userController.userLOginWithOtp
);
router.post(
  "/login-otp",
  middleware.sessionHandle,
  userController.userLOginWithOtpPost
);
...
router.post(
  "/forgot-password",
  middleware.sessionHandle,
  userController.forgortPasswordPOst
);
router.get(
  "/forgot-password",
  middleware.sessionHandle,
  userController.forgortPassword
);
router.post(
  "/update-password",
  middleware.sessionHandle,
...
router.get("/get-cart-count", middleware.checkUserLoggedIn, userController.getCartCound);
...
router.post(
  ...
  middleware.checkUserLoggedIn,
  userController.changePoductQuantity
);
...
router.post(
  "/check-out",
  middleware.checkUserLoggedIn,
  userController.userCheckOutPost
);
router.get(
  "/order-success",
  middleware.checkUserLoggedIn,
...
router.get(
  ...
  middleware.checkUserLoggedIn,
  userController.viewOrderProducts
);
...
router.post(
  ...
  middleware.checkUserLoggedIn,
  userController.removeWishlistProducts
);
